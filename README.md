...
```latex
\left(t*\cos(0.491152592221121)-e^{0.021249625918205495}*|t|*\sin(0.3t)*\sin(0.491152592221121)+54.90719550926761\right)
```

**y-component:**

```latex
\left(42+t*\sin(0.491152592221121)+e^{0.021249625918205495}*|t|*\sin(0.3t)*\cos(0.491152592221121)\right)
```
